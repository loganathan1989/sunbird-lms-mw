...
public class AuditLogServiceImplTest {
  ...
  public void testCreateOrgAuditLog() {
    ...
    AuditOperation op = (AuditOperation) Util.auditLogUrlMap.get(ActorOperations.CREATE_ORG.getValue());
  ...
  public static void delete() {
    for (String auditId : auditIds) {
      ElasticSearchUtil.removeData(EsIndex.sunbirdDataAudit.getIndexName(),
          EsType.history.getTypeName(), auditId);
    }
  }
