package org.sunbird.metrics.actor;
...
public class OrganisationMetricsActorTest {
  ...
  private final static Props props = Props.create(RequestRouterActor.class);
  ...
  private static CassandraOperation operation = new CassandraOperationImpl();
  private static String userId = "456-123";

  @BeforeClass
  public static void setUp() {
    system = ActorSystem.create("RemoteMiddlewareSystem",
        ConfigFactory.load().getConfig("SystemConfig"));
    ref = TestActorRef.create(system, props, "RequestRouterActor");
  ...
  public void testOrgCreationInvalidOrgId() {
    ...
    Assert.assertEquals("INVALID_ORGANISATION_DATA", e.getCode());
  }
